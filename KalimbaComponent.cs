	...
	public class KalimbaComponent {
        ...
        public void GetValues() {
            ...
            if (Model != null) {
                ...
                if (currentSplit == Model.CurrentState.Run.Count + 1 && (Model.CurrentState.Run.Count == 10 || Model.CurrentState.Run.Count == 24)) {
                    HandleGameTimes();
                }
            }
            ...
            if (!IsBoss) {
                for (int i = 0; i < NameSplit.Length; i++) {
                    ...
                    if (IsDis || float.TryParse(IsCP || IsPosX || IsPosY ? sp.Substring(0, sp.Length - 1) : sp, out Value)) {
                        ...
                        IsPosX = false; IsPosY = false; IsCP = false; IsDis = false;
                    }
                }
            } else {
